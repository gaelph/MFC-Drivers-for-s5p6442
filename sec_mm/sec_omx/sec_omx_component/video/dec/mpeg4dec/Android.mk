...
LOCAL_MODULE := libOMX.SEC.M4V.Decoder.s5p6442

ifeq (BOARD_USES_HW_RENDER, true)
    LOCAL_CFLAGS := -DUSE_NO_COPY
else
    LOCAL_CFLAGS := 
endif
...
LOCAL_STATIC_LIBRARIES := libSEC_OMX_Vdec.s5p6442 libsecosal.s5p6442 libsecbasecomponent.s5p6442 libsecmfcdecapi.s5p6442
